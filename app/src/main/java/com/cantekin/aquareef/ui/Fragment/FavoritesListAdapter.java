...
public class FavoritesListAdapter extends ArraySwipeAdapter {
    _baseFragment fragment;

    public FavoritesListAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<String> objects, _baseFragment _fragment) {
